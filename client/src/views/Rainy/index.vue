<template>
    <div class="rain">
        ...
        <img class="rain-bg" src="@img/rain-bg.gif" draggable="false">
...
export default {
            ...
            rainIcon: [
                {
                    ...
                    music: 'http://106.12.123.10:2689/download?code=MTE5LjEzMi4xMS4zMC8wZDBmZjY5Yy0xZDdhLTRmZTEtYTQ4NC0wZWM4YTMxMWY4NzYtLXRodW5kZXIubXAz',
                    active: false
                },
                {
                    on: require('@img/rain/rain2_on.png'),
                    off: require('@img/rain/rain2_off.png'),
                    music: 'http://106.12.123.10:2689/download?code=MTE5LjEzMi4xMS4zMC85MDBmODRmMC0zMWQ4LTRlMTktYTE1OC05ZjkxYTJlZTg0MTYtLWxvdWRUaHVuZGVyLm1wMw==',
                    active: false
                },
                {
                    on: require('@img/rain/rain3_on.png'),
                    off: require('@img/rain/rain3_off.png'),
                    music: 'http://106.12.123.10:2689/download?code=MTE5LjEzMi4xMS4zMC9jZGNhMzJjNy1iZTVlLTRiNjYtYTgxNC1iMDM0ZGM2ZGIzZDctLXJhaW4ubXAz',
                    active: false
                },
                {
                    on: require('@img/rain/rain4_on.png'),
                    off: require('@img/rain/rain4_off.png'),
                    music: 'http://106.12.123.10:2689/download?code=MTE5LjEzMi4xMS4zMC84N2JlZWNjMy1jN2E4LTQ0OTctOGEzOC1mOGU0MTM0NTFjMTAtLWJnbXVzaWMubXAz',
                    active: false
                }
            ],
            loading: true,
    ...
    methods: {
        ...
        userToast () {
          ...
          this.$notify({
            title: '提示',
            message: h('span', { style: 'color: #008c8c'}, '请点击一次页面开始聆听雨声哦！也可以在右下角关闭或者打开其他声音。左上角logo可以回到首页')
          });
        }
    }
}
